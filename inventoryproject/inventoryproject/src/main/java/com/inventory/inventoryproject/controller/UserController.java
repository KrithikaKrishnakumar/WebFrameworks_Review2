...
public class UserController {
    ...
    @DeleteMapping("/inventory/bill/{id}")
    public String deleteMethodNameBill(@PathVariable("id") int a)
    {
        Bill exiBill=billService.getOrder(a);
        if(exiBill!=null)
        {
            billService.deleteProduct(a);
            return "deleted";
        }
        else
        {
    ...
    @DeleteMapping("/inventory/bar/{barcode}")
    public String deleteMethodNameBar(@PathVariable("barcode") String a)
    {
        BarCode exisBarCode=barCodeService.getBarCode(a);
        if(exisBarCode!=null)
        {
            barCodeService.deleteProduct(a);
            return "deleted";
        }
        else
        {
    ...
    @DeleteMapping("/inventory/supplier/{id}")
    public String deleteMethodNameSup(@PathVariable("id") int a)
    {
        Supplier exisSupplier=supplierService.getsupplier(a);
        if(exisSupplier!=null)
        {
            supplierService.deleteSupplier(a);
            return "deleted";
        }
        else
        {
...
// ---------------------------PAGINATION-----------------------------------------
    ...
    @GetMapping("/inventory/product/getallproducts")
